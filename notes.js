...
let displayNotes = () => {
  ...
  notes.forEach((note) => {
    ...
    noteDiv.addEventListener("mouseover", (event) => {
      deleteButton.classList.remove("edit_float");
      deleteButton.classList.add("edit_float_hover");
    });
    noteDiv.addEventListener("mouseout", (event) => {
      deleteButton.classList.remove("edit_float_hover");
      deleteButton.classList.add("edit_float");
    });
